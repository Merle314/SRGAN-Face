...
Flags.DEGINE_string('input_dir', None, 'The directory of the input tfrecord data dir')
...
Flags.DEGINE_string('perceptual_scope', 'vgg_19', 'vgg_19, InceptionResnetV1, Resface')
