...
Flags.DEFINE_string('output_dir', '/media/lab225/Document2/merle/train_result/gan_inter', 'The output directory of the checkpoint')
Flags.DEFINE_string('summary_dir', '/media/lab225/Document2/merle/train_result/gan_inter/log', 'The dirctory to output the summary')
...
if FLAGS.pre_trained_model_type == 'SRGAN':
    ...
    #     print(var.name)
    exclusions = ['generator/generator_unit/subpixelconv_stage2/conv/interpolation_kernel:0',
                  'generator/generator_unit/subpixelconv_stage1/conv/interpolation_kernel:0',
