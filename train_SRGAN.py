...
Flags.DEFINE_string('output_dir', '/media/lab225/Document2/merle/train_result/gan_embedding', 'The output directory of the checkpoint')
Flags.DEFINE_string('summary_dir', '/media/lab225/Document2/merle/train_result/gan_embedding/log', 'The dirctory to output the summary')
Flags.DEFINE_string('checkpoint', '/media/lab225/Document2/merle/train_result/gan_feature/model-100000', 'If provided, the weight will be restored from the provided checkpoint')
...
Flags.DEFINE_float('perceptual_scaling', 0.061, 'The scaling factor for the perceptual loss if using vgg perceptual loss')
...
if FLAGS.pre_trained_model_type == 'SRGAN':
    ...
    #     print(var.name)
    exclusions = ['generator/generator_unit/subpixelconv_stage2/conv/interpolation_kernel:0', 'generator/generator_unit/subpixelconv_stage1/conv/interpolation_kernel:0']
    # exclusions = []
