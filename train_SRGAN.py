...
from lib.SRGAN_DC import SRGAN

Flags = tf.app.flags

# The system parameter
Flags.DEFINE_string('output_dir', '/media/lab225/Document2/merle/train_result/gan_icnr', 'The output directory of the checkpoint')
Flags.DEFINE_string('summary_dir', '/media/lab225/Document2/merle/train_result/gan_icnr/log', 'The dirctory to output the summary')
Flags.DEFINE_string('checkpoint', '/media/lab225/Document2/merle/train_result/gan_feature/model-120000', 'If provided, the weight will be restored from the provided checkpoint')
...
Flags.DEFINE_string('perceptual_ckpt', '/media/lab225/Documents/merle/faceDataSet/Models/20181029-185447/model-20181029-185447.ckpt-132000', 'path to checkpoint file for the perceptual model')
...
if FLAGS.pre_trained_model_type == 'SRGAN':
    ...
    #     print(var.name)
    exclusions = ['generator/generator_unit/subpixelconv_stage1/conv/kernel_1:0',
                  'generator/generator_unit/subpixelconv_stage1/conv/kernel_2:0',
                  'generator/generator_unit/subpixelconv_stage1/conv/kernel_3:0',
                  'generator/generator_unit/subpixelconv_stage1/conv/kernel_4:0',
                  'generator/generator_unit/subpixelconv_stage2/conv/kernel_1:0',
                  'generator/generator_unit/subpixelconv_stage2/conv/kernel_2:0',
                  'generator/generator_unit/subpixelconv_stage2/conv/kernel_3:0',
                  'generator/generator_unit/subpixelconv_stage2/conv/kernel_4:0']
                #   'generator/generator_unit/subpixelconv_stage1/conv/kernel:0',
                #   'generator/generator_unit/subpixelconv_stage2/conv/kernel:0']
    # exclusions = []
