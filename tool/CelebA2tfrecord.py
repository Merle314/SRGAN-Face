...
if __name__ == "__main__":
    ...
    convert('/media/lab225/Document2/merle/faceDataset/celeba_align_112x96',
            '/media/lab225/Document2/merle/faceDataset/celeba_align_112x96_tfrecord_new',
            crop_size=[112, 112], out_size=[112, 96], exts=['jpg'], num_shards=64, tfrecords_prefix='celeba')
